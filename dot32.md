...
## Hei ✌️ 
I'm Dot32, a 16 year old from Western Australia. I started making games when I was 9, and I haven't stopped!
On this site I have decided to host some tutorials, which you can check out [here](/tutorials)!
...
## Webdev
Apart from my comfort zone of Love2D, I have some experience in building websites, and this website is an example of that. Built with javascript, this website is a "Single Page Application", which is to say that there is only a single page, and clicking through the site will simply update the content of the page. Try navigating through the navbar now, and notice that the page never reloads. I also built in functionality to edit the URL when changing page and to read the URL for page inference.
